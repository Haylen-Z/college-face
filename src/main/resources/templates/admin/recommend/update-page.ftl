...
<div    class="container">
        ...
        <div class="col-8 m-4">
            <form>
                <div class="form-group">
                    ...
                    <input type="text" value="${recommend.title}"  class="form-control" id="title" >
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">文章id</label>
                    <input value="${recommend.articleId}" class="form-control" id="article-id" >
                </div>
                <div class="form-group">
                ...
                <img src="${recommend.cover}" id="img" class="img-fluid">
            </form>
    ...
    <script>
        function submitClick() {
            ...
            $.ajax({
                url: "/admin/recommends/update/${recommend.id}",
                method: "POST",
